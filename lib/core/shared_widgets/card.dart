...
class CardDetails extends StatelessWidget {
  ...
  final List<String> imagesDoctors = [
  ...
  Widget build(BuildContext context) {
    int imageIndex = _currentImageIndex;
    _currentImageIndex = (_currentImageIndex + 1) % imagesDoctors.length;
          ...
          child: Row(
            children: [
              ClipRRect(
                ...
                child: (imageDoctor == null ||
                    imageDoctor!.isEmpty ||
                    imageDoctor!.contains("via.placeholder.com"))
                    ? Image.asset(
                  imagesDoctors[imageIndex],
                  height: 110.h,
                  width: 110.w,
                  fit: BoxFit.cover,
                )
