...
class AlreadyHaveAccount extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return RichText(text:TextSpan(children: [
      TextSpan(text: "Don't have an account?",style: TextThemes.font13LightBlackRegular),
      TextSpan(
          recognizer: TapGestureRecognizer()..onTap = () {
            Navigator.push(context, MaterialPageRoute(builder: (context)=>BlocProvider(create: (BuildContext context) =>getIt<RegisterCubit>(),
                child: Register())));
          },
          text: "  Sign up",style: TextThemes.font13BlueRegular)
    ]),);
  }
}
